...
public class FileUtils {
    ...
    public static void main(String[] args) {
        String url = "D:\\ltian\\test\\AndroidManifest.xml";
        ...
        try {
            ...
            if(filesize < Integer.MAX_VALUE){
                size = Integer.parseInt(String.valueOf(filesize));
            }
            byte[] buffer = new byte[size];
            fileInputStream.read(buffer);
            FileUtils.byteToFile(buffer,"D:\\ltian\\test\\AndroidManifest2.xml");
        }catch (IOException e){
