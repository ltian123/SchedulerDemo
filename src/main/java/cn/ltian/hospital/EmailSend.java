...
public class EmailSend {
    ...
    public static void send(MessageInfo messageInfo) throws AddressException,MessagingException {
        ...
        // 设置邮件内容
        message.setText(messageInfo.getMsg());
        // 得到邮差对象
        Transport transport = session.getTransport();
        // 连接自己的邮箱账户
        transport.connect("978936142@qq.com", "fbxcqphmvpchbfeg");// 密码为QQ邮箱开通的stmp服务后得到的客户端授权码
        // 发送邮件
